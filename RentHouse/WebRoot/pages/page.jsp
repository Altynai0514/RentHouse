...
<table >
	...
	<td width="80" style="padding-top: 1px;">
		到第&nbsp;<s:textfield name="page.index" id="index" style="height: 14px; width: 35px" size="3"></s:textfield>页
	</td>
	<td width="40" ><!-- style="float: left" -->
		<input type="image" height="18" src="<%=request.getContextPath()%>/img/go<s:if test="null == page.list || page.list.size<1">2</s:if>.gif"/>
	</td>
	</tr>
</table>
</div>
