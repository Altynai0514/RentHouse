...
jQuery.extend(Boxy, {
    ...
    DEFAULT_X:          50,
    DEFAULT_Y:          50,
    zIndex:             999995,//1337, modify by dongxun
    ...
    alert: function(message, callback, options) {
    	...
    	//start bugNo.844 用户修改密码点确定后再跳转到个人信息页面  董勋  2013-03-05
    	if (callback == undefined) {
    		//解决ie9下弹框，系统锁死的bug
    		return Boxy.ask(message, ['确认'], callback, options);
    	} else {
	    	return Boxy.ask(message, ['确认'], function(response) {
	            if (response == '确认') callback();
	        }, options);
    	}
    	//end bugNo.844 用户修改密码点确定后再跳转到个人信息页面  董勋  2013-03-05
    },
    ...
    ask: function(question, answers, callback, options) {
        ...
        //修复确认界面按空格和Enter键黑屏问题 顾洋洋 2013/11/29
        jQuery(".boxy-btn1").focus();
      //修复确认界面按空格和Enter键黑屏问题 顾洋洋 2013/11/29
    },
